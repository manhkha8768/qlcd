...
const TRUONG_ANH_XA = [
    ...
    { k: 'so_kiem_ke',      n: 'Số kiểm kê' },
    { k: 'so_quan_ly',      n: 'Số quản lý' },
    { k: 'so_luong_quan_ly', n: 'Số lượng quản lý' },
    { k: 'so_luong_kiem_ke', n: 'Số lượng kiểm kê' },
    { k: 'so_luong_doi_chieu', n: 'Số lượng đối chiếu' },
    { k: 'danh_gia_ky_thuat', n: 'Đánh giá % kỹ thuật' },
    { k: 'ghi_chu_kiem_ke', n: 'Ghi chú kiểm kê' },
    { k: 'quan_ly_theo_quyet_dinh', n: 'QL theo lệnh/QĐ' },
