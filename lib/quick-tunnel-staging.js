...
function createController({ runCompose, fetchImpl, readLogs, writeEvidence, now = Date.now, commit = 'unknown', sleep = ms => new Promise(resolve => setTimeout(resolve, ms)), timeoutMs = POLL_TIMEOUT_MS, scheduleTimeout: timer = createTimeout }) {
