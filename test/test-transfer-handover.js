...
const form=new FormData();form.append('loai_chung_tu','bien_ban_giao_nhan');form.append('file',new Blob([Buffer.from('%PDF-1.4\n% UAT bien ban giao nhan\n')],{type:'application/pdf'}),'bien-ban.pdf');
